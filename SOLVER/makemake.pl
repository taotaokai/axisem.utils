...
#
$make_axisem_macros = "../setup/make_axisem.macros";
print MAKEFILE "include $make_axisem_macros\n\n";
...
sub MakeDepends {
   ...
   foreach $file (<${lang}>) {
      ...
      while (<FILE>) {
         ...
         print MAKEFILE " Makefile $make_axisem_macros \n";
         undef @incs;
      }
   }
...
print MAKEFILE "kdtree2.o:  Makefile $make_axisem_macros\n";
